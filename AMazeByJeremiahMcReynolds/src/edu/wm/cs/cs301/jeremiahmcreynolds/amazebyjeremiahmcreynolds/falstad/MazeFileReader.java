...
public class MazeFileReader {
	 ...
	 */
	public MazeFileReader(GraphicsWrapper gw, String filename) {
		this.gw = gw;
		load(filename) ;
	}
...
//			if(s.getGraphics().getColor().getRGB() != s2.getGraphics().getColor().getRGB()) 
