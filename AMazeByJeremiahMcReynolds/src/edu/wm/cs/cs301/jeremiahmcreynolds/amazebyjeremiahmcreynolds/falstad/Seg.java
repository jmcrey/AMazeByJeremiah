...
import edu.wm.cs.cs301.jeremiahmcreynolds.amazebyjeremiahmcreynolds.falstad.GraphicsWrapper.GWColor;
...
public class Seg {
	 ...
	 * @param cc
	 */
	Seg(GraphicsWrapper gw, int psx, int psy, int pdx, int pdy, int cl, int cc) {
		this.gw = gw;
		x = psx;
		y = psy;
		dx = pdx;
