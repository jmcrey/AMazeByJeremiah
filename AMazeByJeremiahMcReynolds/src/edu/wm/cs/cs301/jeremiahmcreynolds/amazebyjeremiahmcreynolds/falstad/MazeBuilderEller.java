...
public class MazeBuilderEller extends MazeBuilder implements Runnable{
    ...
    public MazeBuilderEller(GraphicsWrapper gw) {
    	super(gw);
    	this.gw = gw;
    	System.out.println("MazeBuilderEller uses Eller's algorithm to generate maze.");
    }
	public MazeBuilderEller(boolean det, GraphicsWrapper gw) {
		super(det, gw);
		System.out.println("MazeBuilderEller uses Eller's algorithm to generate maze...");
	}
    ...
    protected void generatePathways() {
   	...
   	public void run() {
   		...
   		try {
   			...
   			final BSPBuilder b = new BSPBuilder(gw, maze, dists, cells, width, height, colchange, expectedPartiters) ;
