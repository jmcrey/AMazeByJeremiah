...
public class Maze  {
	...
	public Maze(String algorithm, String driver, int difficulty){
		super();
		panel = new MazePanel();
	...
	**/
	...
	public void setMyApp(MazeApplication parent){
		this.myApp = parent;
	}
	
	public MazeApplication getMyApp(){
		return myApp;
	}
